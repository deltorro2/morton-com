...
- [ ] Application launches and shows two panels
- [ ] Left panel shows local home directory
- [ ] Can navigate local folders (double-click, backspace)
- [ ] Switching right panel to "GCS" prompts for sign-in (first time)
- [ ] Browser opens for Google sign-in
- [ ] After sign-in, GCS panel shows list of buckets
- [ ] Your Google email appears in the application
- [ ] Can navigate into a bucket and see contents
- [ ] Can copy a local file to GCS bucket
- [ ] Can download a GCS object to local folder
- [ ] Sign out clears credentials and shows sign-in prompt again
- [ ] After restart, stored credentials work automatically

## Example Session

```
1. Launch application
2. Left panel: Navigate to ~/Documents
3. Right panel: Switch to GCS → Sign-in prompt appears
4. Click "Sign in with Google" → Browser opens
5. Complete Google sign-in, grant permissions
6. Right panel: Select project "my-project"
7. Right panel: Enter bucket "my-bucket"
8. Left panel: Select file "report.pdf"
9. Press Cmd+C (copy), then Tab to right panel, then Cmd+V (paste)
10. Watch progress dialog
11. Verify file appears in right panel
12. (Optional) Click email → Sign Out to clear credentials
```
